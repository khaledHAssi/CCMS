        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.courses.update', $course) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input id="start_date" name="start_date" type="text" placeholder="Name" class="form-control @error('start_date') is-invalid @enderror " value="{{ old('start_date', $course->start_date) }}" />
                    @error('start_date')
                        <small class="invalid-feedback">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input id="end_date" name="end_date" type="text" placeholder="Name" class="form-control @error('end_date') is-invalid @enderror " value="{{ old('end_date', $course->end_date) }}" />
                    @error('end_date')
                        <small class="invalid-feedback">{{ $message }}</small>
                    @enderror
