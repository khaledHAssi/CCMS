                ...
                <tbody>
                    ...
                    @forelse ($times as $time)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.AvailableTimes.edit', $time) }}" class="btn btn-primary btn-sm"> <i class="fas fa-edit"></i> </a>
                                <form class="d-inline" action="{{ route('admin.AvailableTimes.destroy', $time->id) }}" method="POST">
                                @csrf
                                @method('delete')
