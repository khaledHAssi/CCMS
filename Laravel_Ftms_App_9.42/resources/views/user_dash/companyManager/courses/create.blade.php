                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user_dash.cmCourses.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="description" name="description" type="text" placeholder="Name"
                        ...
                        <div class="mb-3">
                            ...
                            <input id="start_date" name="start_date" type="date" placeholder="Name"
                        ...
                        <div class="mb-3">
                            ...
                            <input id="end_date" name="end_date" type="date" placeholder="Name"
