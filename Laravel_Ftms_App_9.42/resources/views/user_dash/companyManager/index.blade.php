                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-header text-white"
                                style="background: url('{{ asset($company->image) }}') center center;">
                                <section class="bg-black text-white" style="opacity:70% ; padding: 1em;">
                                    <div class="container bold " style="text-align:left">
                                        ...
                                        <h5 class="widget-user-desc" style="margin-top: .5em; font-size: 1em"><span
                                                style="display: block;font-weight: bold;">Description :</span>
