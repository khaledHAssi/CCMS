    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-body">
                    <h1>{{ $title }}</h1>
                    <form action="{{ route('user_dash.doctor.dash.availableTimeStore') }}" method="POST"
                        ...
                        <input type="text" hidden value="{{ $expertId }}" class="form-control" name="expert_id" />
                        @if ($companyId)
                            <input type="text" hidden value="{{ $companyId }}" class="form-control"
                                name="company_id" />
                        @endif
