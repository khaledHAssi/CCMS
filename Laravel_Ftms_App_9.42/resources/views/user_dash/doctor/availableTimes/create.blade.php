...
<div class="container-fluid">
    <div class="card mt-4">
        <div class="card-body">
            <h1>{{ $title }}</h1>
            <form action="{{ route('user_dash.doctor.dash.availableTimeStore') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="text" hidden  value="{{$id}}" class="form-control" name="expert_id"/>
