...
<head>
    ...
    <title>DASH-DOCTOR | @yield('title', env('APP_NAME'))</title>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{ route('user_dash.doctor.dash.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user_dash.doctor.dash.expertIndex') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user_dash.doctor.dash.AvailableTimeIndex') }}" class="nav-link">
